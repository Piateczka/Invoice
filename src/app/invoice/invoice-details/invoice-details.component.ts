        ...
        this.inv.getDetails(this.id).subscribe((data) => {
            this.invoiceForm = this.fb.group({
                client: this.fb.group({
                    ...
                    nip: [data.client.nip, [Validators.required]],
                    street: [data.client.street, [Validators.required]],
                    buildingNumber: [data.client.buildingNumber],
                    premiseNumber: [data.client.premiseNumber, [Validators.required]],
                ...
                invoiceRow: this.fb.array(data.invoiceRow.map(row => this.fb.group({
                    ...
                    varRate: [row.varRate, [Validators.required, Validators.maxLength(2)]],
                    isEditable: [false]
                }), Validators.required))
            });
